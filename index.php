	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item">><a href="#" data-toggle="modal" data-target="#myModal" class="nav-link">Sign Up</a></li>
            <li class="nav-item"><a href="#login-vanad-clinic" class="nav-link">Login</a></li>
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="patientFirstName" value="" class="form-control" placeholder="First Name" required />
                                            </div>
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="patientLastName" value="" class="form-control" placeholder="Last Name" required />
                                            </div>
                                        </div>
                                        
                                        <input type="text" name="patientEmail" value="" class="form-control" placeholder="Your Email"  required/>
                                        <input type="number" name="icPatient" value="" class="form-control" placeholder="Your IC Number"  required/>
      ...
      <div class="slider-item" style="background-image:url(img/Low-Motility-of-Sperm.jpg);">
        ...
        <div class="col-md-6 d-flex align-items-stretch">
                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
					...
					<div class="col-md-3 d-flex align-items-stretch">
						<div class="consultation w-100 text-center px-4 px-md-5">
            <h3 class="mb-4" id="login-vanad-clinic">Login</h3>
